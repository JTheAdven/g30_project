...
public class Item implements Serializable {
    ...
    public Item(int itemID, String itemName, double itemPrice, int itemAmount, String itemDesc) throws IncorrectItemInformationException {
        if(itemID < 1 || itemName == null
        || itemName.isBlank() || itemPrice < 0 || itemAmount < 0 || itemDesc == null
    ...
    public String checkItemAmount() throws IncorrectItemInformationException {
        if(itemAmount == 0) return itemName + ": Out of stock!";
        if(itemAmount > 0) return itemName + ": " + itemAmount;
