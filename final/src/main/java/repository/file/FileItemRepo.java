...
public class FileItemRepo implements ItemRepo {
    private String filename = "E:\\Study folder\\Year 1\\Term 2\\INT103\\project\\final\\src\\main\\java\\repository\\file\\itemFile.txt";
    private List<Item> items;
    private int nextID;

    public FileItemRepo(String filename) {
